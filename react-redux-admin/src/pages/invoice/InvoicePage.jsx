  ...
  return (
    <div className="invoice-container-wrap">
      <div className="invoice-container">
        <main>
          <div className="themeholy-invoice invoice_style14">
            <div className="download-inner" id="download_section">
              <header className="themeholy-header header-layout10">
                <div className="row align-items-center justify-content-between">
                  <div className="col-auto">
                    <div className="header-logo">
                      <a href="index.html">
                        <img src={logo} alt="Invar" />
                      </a>
                    </div>
                  </div>
                  <div className="col-auto">
              ...
              <div className="address-bg1 mt-4">
                <div className="row gx-0 justify-content-between">
                  <div className="col-6">
                    <div className="invoice-left border-right">
                      <b>Invoice To:</b>
                      <address>
                        Alex Farnandes
                        <br />
              ...
              <p className="company-address style2">
                <b>Invar Inc:</b>
                <br />
                12th Floor, Plot No.5, IFIC Bank, Gausin Rod, Suite 250-20,
                Franchisco USA 2022.
              </p>
              <p className="invoice-note mt-3">
                ...
                <b>NOTE: </b>This is computer generated receipt and does not
